---
title: "KaroCar Platform Local Development Environment Setup"
...
<Note>
  The `.npmrc` file at the repository root is currently empty. pnpm's default
  workspace resolution behaviour applies — `workspace:*` links are resolved
  directly from the `packages/` directory without any additional configuration.
</Note>
