---
title: "Button Component Reference — @karo-car/ui React Library"
sidebarTitle: "Button"
description: "Client-side React button component that fires a browser alert with the consuming app's name on click. Marked \"use client\", exported from @karo-car/ui."
---
